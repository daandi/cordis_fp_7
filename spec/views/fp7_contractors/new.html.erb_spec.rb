...
describe "fp7_contractors/new" do
  before(:each) do
    assign(:fp7_contractor, stub_model(Fp7Contractor,
      :rcn => "MyString",
  ...
  it "renders new fp7_contractor form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", fp7_contractors_path, "post" do
